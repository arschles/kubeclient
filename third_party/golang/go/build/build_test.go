...
func TestLocalDirectory(t *testing.T) {
	...
	if p.ImportPath != "github.com/jchauncey/kubeclient/third_party/golang/go/build" {
		t.Fatalf("ImportPath=%q, want %q", p.ImportPath, "github.com/jchauncey/kubeclient/third_party/golang/go/build")
	}
}
