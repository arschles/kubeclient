...
import (
	...
	pkg2_api "github.com/jchauncey/kubeclient/api"
	pkg4_resource "github.com/jchauncey/kubeclient/api/resource"
	pkg1_unversioned "github.com/jchauncey/kubeclient/api/unversioned"
	pkg3_types "github.com/jchauncey/kubeclient/types"
	pkg6_intstr "github.com/jchauncey/kubeclient/util/intstr"
	"reflect"
	"runtime"
			...
			if yyr453 || yy2arr453 {
				...
				if yyq453[4] {
					if x.RevisionHistoryLimit == nil {
						...
						yy467 := *x.RevisionHistoryLimit
						yym468 := z.EncBinary()
						_ = yym468
						if false {
						} else {
							r.EncodeInt(int64(yy467))
						}
					}
				} else {
					r.EncodeNil()
...
func (x codecSelfer1234) decSliceDeployment(v *[]Deployment, d *codec1978.Decoder) {
	...
	if yyl1441 == 0 {
		...
		if yyl1441 > cap(yyv1441) {
			...
			yyv21441 := yyv1441
			yyrl1441, yyrt1441 = z.DecInferLen(yyl1441, z.DecBasicHandle().MaxInitLen, 632)
			if yyrt1441 {
